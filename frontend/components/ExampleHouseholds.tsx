...
function toImpactResponse(h: ExampleHousehold): HouseholdImpactResponse {
  ...
  const federalTaxChange = h.reform.income_tax - h.baseline.income_tax;
  return {
    ...
    benefit_at_income: {
      ...
      state_tax_change: h.nj_tax_change,
          ...
          return (
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-2 leading-5">
                NJ tax: {fmtCurrency(h.baseline.nj_income_tax)} →{' '}
                {fmtCurrency(h.reform.nj_income_tax)}
              </p>
            </button>
          );
        })}
