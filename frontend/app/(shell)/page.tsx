...
function HouseholdImpactTab() {
  ...
  const getInitialValues = () => {
    if (typeof window === 'undefined') {
      return { income: 50000, age: 35, state: 'NJ', married: false, dependents: [5] };
    }
  ...
  /** Click handler from ExampleHouseholds. */
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-5 mt-5">
          ...
          <div>
            ...
            {dependentAges.length > 0 && (
              <div className="mt-2">
                <span className="block text-xs font-medium text-gray-500 mb-1">Age(s) - children under 12 qualify for the expanded NJ CTC</span>
